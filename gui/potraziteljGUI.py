...
class PotraziteljPanel(tk.Frame):
    ...
    def proveriIDFrameWidgets(self):
        ...
        self.ProveriIDButton = tk.Button(self.checkIDFrame,text="Proveri(Check ID)",command=self.proveriID)
        self.CheckBoxNemamIDState = tk.IntVar()
        self.CheckBoxNemamID = tk.Checkbutton(self.checkIDFrame,text="Nemam ID(No ID)",command=self.disableIDInput,variable=self.CheckBoxNemamIDState)
    ...
    def podaciFrameWidgets(self):
        ...
        self.ImeLabel = tk.Label(self.PodaciFrame,text="Ime:(Name)")
        self.ImeInput = tk.Entry(self.PodaciFrame,state="disabled")
        self.PrezimeLabel = tk.Label(self.PodaciFrame,text="Prezime:(Surname)")
        self.PrezimeInput = tk.Entry(self.PodaciFrame,state="disabled")
        self.BrojTelefonaLabel = tk.Label(self.PodaciFrame,text="Broj Telefona:(Tel)")
    ...
    def dodajRobuFrameWidgets(self):
        ...
        self.robaLabel = tk.Label(self.DodajRobuFrame,text="Roba(Name):")
        self.opisRobaLabel = tk.Label(self.DodajRobuFrame,text="Opis(Descr):")
        self.robaInput = tk.Entry(self.DodajRobuFrame,width=15)
        self.opisRobeInput = tk.Entry(self.DodajRobuFrame,width=15)

        self.duzinaRobeLabel = tk.Label(self.DodajRobuFrame,text="Duzina:(Lenght)")
        self.duzinaRobeInput = tk.Entry(self.DodajRobuFrame,width=5)
        self.sirinaRobeLabel = tk.Label(self.DodajRobuFrame,text="Sirina:(Width)")
        self.sirinaRobeInput = tk.Entry(self.DodajRobuFrame,width=5)
        self.visinaRobeLabel = tk.Label(self.DodajRobuFrame,text="Visina:(Height)")
        self.visinaRobeInput = tk.Entry(self.DodajRobuFrame,width=5)
        self.tezinaRobeLabel = tk.Label(self.DodajRobuFrame,text="Tezina:(Weight kgs)")
    ...
    def odredisteFrameWidgets(self):
        ...
        self.odredisteLabel = tk.Label(self.odresiteFrame,text="Odredista:(Destinations)")
